  ...
  private guardianInit(){
    this.Guardian.isrunning().subscribe(
      ...
      error => {
        ...
        this.splash = true;
        this.splash_TITLE = 'Conexión perdida con Aurora Studios';
        this.splash_REASON = 'Hemos perdido la conexión con Aurora HomeServices®️ WebKit. Se intentará reiniciar la conexión en unos momentos o puede intentar refrescar la pagina.'      }
    )
  }
